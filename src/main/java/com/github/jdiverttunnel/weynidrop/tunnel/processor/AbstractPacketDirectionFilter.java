 ...
 */
public abstract class AbstractPacketDirectionFilter implements PacketHandler, PacketTypeProcessor {
    private WinDivertFilter filter;

    protected AbstractPacketDirectionFilter(WinDivertFilter filter) {
        if (filter == null){
